...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f'Switched to {next_db_path}'))

    def update_settings(self, next_db_path):
        relative_path = os.path.join('..','timetable_generator','timetable_generator', 'settings.py')
        settings_file = os.path.abspath(relative_path)        # Update this with the actual path to your settings.py file
